        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-8 col-xl-9">
                    <h2 class="h3 text-xs-center font-weight-bold text-md-left">Agencia de programación de aplicaciones</h2>
        ...
        <div class="container">
            ...
            <div class="row">
                <ul class="col-xs-6  col-lg-4 text-xs-center text-lg-left">
                    <li>
                        ...
                        <div class="contenedor-eleccion">
                            ...
                            <p class="hidden-md-down">Para empresa que requiere ampliar su plataforma de gestión.</p>
                        </div>
                    </li>
                    <li>
                ...
                <div class="hidden-md-down  col-lg-4">
                    <img src="images/mundo.svg" alt="mundo móvil">
                </div>
            ...
            <h2 class="text-xs-center font-weight-bold">Nuestros Servicios</h2>
                <div class="row">
                    <article class="col-md-4">
                        ...
                        <p class="hidden-sm-down">Desarrollamos aplicaciones móviles y plataformas wev.Nuestra principal cualidad esta en el desarrollo de software a medida de tus necesidades.</p>
    ...
    <section class="ultimos-proyectos p-y-1">
        <div class="container">
            ...
            <div class="owl-carousel">
                ...
                <a href="#">
                    <h4>App Perú</h4>
                    <img src="images/proyecto5.jpg" alt="Proyecto App Perú">
                </a>
                
                <a href="#">
                    <h4>App Janito</h4>
                    <img src="images/proyecto6.jpg" alt="Proyecto App Janito">
                </a>
            </div>
        </div>
    </section>
